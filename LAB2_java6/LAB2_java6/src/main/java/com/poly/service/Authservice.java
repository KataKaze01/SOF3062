...
public class Authservice {
    ...
    public List<String> getRoles() {
        return this.getAuthentication().getAuthorities().stream()
                .map(au -> au.getAuthority().substring(5)) // cắt "ROLE_" ở đầu
                .toList();
    }
     ...
     * @return true nếu user có ít nhất một trong các vai trò cần kiểm tra
     */
     ...
     * @param username tên đăng nhập user mới
     * @param password mật khẩu đăng nhập user mới
